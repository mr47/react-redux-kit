...
import { SETUP_TABS, SET_TABS_ITEMS, SET_ACTIVE_TAB, SET_ACTIVE_TAB_BY_INDEX, SETUP_TABS_BY_MENU_INDEX } from '../reducers';
...
export const setTabItems = createAction(SET_TABS_ITEMS);
