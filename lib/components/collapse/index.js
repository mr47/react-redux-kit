...
var _ELabOrodemoReactNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
    filename: 'src/components/collapse/index.js',
...
var Collapse = _wrapComponent('Collapse')((_temp = _class = function (_Component) {
    ...
    _createClass(Collapse, [{
        key: 'inCollapsed',
        value: function inCollapsed(collapsedItems, id) {
        ...
        value: function render() {
            ...
            var collapseItemClick = _props.collapseItemClick;
            var collapsedItems = _props.collapsedItems;

            console.log('collapsedItems', collapsedItems);
            var collapseItems = items.map(function (item) {
                console.log('collapsedItems:', item.id, _this2.inCollapsed(collapsedItems, item.id));
                return _react3.default.createElement(_item.CollapseItem, _extends({}, item, { collapsed: _this2.inCollapsed(collapsedItems, item.id), collapseItemClick: collapseItemClick, key: item.id }));
            });
            return _react3.default.createElement(
                'div',
                { className: _collapse2.default.base },
                collapseItems
            );
        }
    }]);
    ...
    collapsedItems: _react2.PropTypes.array.isRequired,
